...
import info.imtushar.foodrecipe.models.ExtendedIngredient
import info.imtushar.foodrecipe.util.Constants.Companion.BASE_IMAGE_URL
...
class IngredientsAdapter: RecyclerView.Adapter<IngredientsAdapter.MyViewHolder>() {
    ...
    fun setData(newIngredients: List<ExtendedIngredient>){
        ...
        val duffUtilResult = DiffUtil.calculateDiff(ingredientsDiffUtil)
